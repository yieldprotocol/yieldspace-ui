...
const Input = tw.input`text-2xl rounded-md font-bold appearance-none w-full bg-gray-800 focus:text-gray-50 text-gray-300  py-3 px-4 leading-tight focus:outline-none `;
