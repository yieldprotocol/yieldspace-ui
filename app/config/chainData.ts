export const RPC_URLS: { [chainId: number]: string } = {
  ...
  42: process.env.NEXT_PUBLIC_RPC_URL_42 as string,
  10: process.env.NEXT_PUBLIC_RPC_URL_10 as string,
  69: process.env.NEXT_PUBLIC_RPC_URL_69 as string,
  42161: process.env.NEXT_PUBLIC_RPC_URL_42161 as string,
  421611: process.env.NEXT_PUBLIC_RPC_URL_421611 as string,
};
