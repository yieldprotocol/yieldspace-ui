...
export interface LadleInterface extends utils.Interface {
  contractName: "Ladle";
  functions: {
...
export interface Ladle extends BaseContract {
  contractName: "Ladle";
